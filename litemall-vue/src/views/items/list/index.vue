<template>
        ...
        <div class="item_list over-hide">
            <van-nav-bar :title="categoryName" left-text="返回" left-arrow @click-left="goback"/>
...
<script>
    ...
    import {Search, Tab, Tabs, Popup, NavBar} from 'vant';
        ...
        methods: {
            ...
            init() {
                goodsCategory({id: this.categoryId}).then(res => {
                    this.categoryName = res.data.data.parentCategory.name;
