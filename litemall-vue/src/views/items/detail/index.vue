<template>
  <div class="item_detail">
    <van-nav-bar :title="goods.info.name" left-text="返回" left-arrow @click-left="goback"/>
    <van-swipe :autoplay="3000">
      <van-swipe-item v-for="(image, index) in goods.info.gallery" :key="index">
        <img :src="image" @click="previewImg($event)" width="100%">
      </van-swipe-item>
    </van-swipe>
  ...
  <div class="item_cell_group">
    ...
    <div class="item_desc">
      ...
      <div class="item_desc_wrap" v-if="goods.info.detail" v-html="goods.info.detail" @click="previewImg($event)"></div>
...
import { Sku, Swipe, SwipeItem, GoodsAction, GoodsActionBigBtn, GoodsActionMiniBtn, Popup,NavBar } from 'vant';
