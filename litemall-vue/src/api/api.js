...
const GetNew= 'wx/home/new'; //新品换一批
...
const GetHot= 'wx/home/hot'; //人气换一批
...
const ChangeSex = 'wx/user/sex';//修改性别
...
const ResetPhone = 'wx/auth/resetPhone';
...
const StorageUploadBase64='wx/storage/uploadbase64'; //图片上传,
export function storageUploadBase64(data) {
  return request({
    url: StorageUploadBase64,
    method: 'post',
    data
  })
}
