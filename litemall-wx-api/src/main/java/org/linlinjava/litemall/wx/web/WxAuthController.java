...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        if (userList.size() > 1) {
            ...
            return ResponseUtil.fail(AUTH_INVALID_ACCOUNT, "手机号码不存在");
        } else {
            user = userList.get(0);
        }
...
//        String mobile = JacksonUtil.parseString(body, "mobile");
        ...
        user.setMobile("100000000000");
        user.setAvatar("http://129.204.126.160:8080/wx/storage/fetch/uim9f695vqnzje4z5gf2.jpg");
    ...
    public Object reset(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        ...
        BCryptPasswordEncoder encoder = new BCryptPasswordEncoder();
        if (encoder.matches(oldPassword, userOldPassword)) {
