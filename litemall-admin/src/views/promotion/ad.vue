<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.name" clearable class="filter-item" style="width: 200px;" placeholder="请输入轮播图标题"/>
      <el-input v-model="listQuery.content" clearable class="filter-item" style="width: 200px;" placeholder="请输入轮播图内容"/>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="轮播图内容" prop="content"/>

      <el-table-column align="center" label="轮播图图片" prop="url">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        content: [
          { required: true, message: '轮播图内容不能为空', trigger: 'blur' }
        ],
        url: [{ required: true, message: '轮播图链接不能为空', trigger: 'blur' }]
      },
