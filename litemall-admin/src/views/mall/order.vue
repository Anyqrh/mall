...
<!--      <el-table-column align="center" label="用户ID" prop="userId"/>-->
      ...
      <el-table-column align="center" label="订单备注信息" prop="message"/>
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-permission="['GET /admin/order/pay']"  v-if="scope.row.orderStatus==101" type="primary" size="mini" @click="alreadyPay(scope.row)">已付款</el-button>
    ...
    <el-dialog :visible.sync="orderDialogVisible" title="订单详情" width="800">
      ...
      <el-form :data="orderDetail" label-position="left">
        ...
        <el-form-item label="费用信息">
          <span>
            {{ orderDetail.order.actualPrice }}元
          </span>
        </el-form-item>
...
<!--        </el-form-item>-->
        <el-form-item label="快递信息">
          <div v-if="orderDetail.order.shipTime==null">
            暂未发货
          </div>
          <div v-else>
        ...
        <el-form-item label="收货信息">
          <div v-if="orderDetail.order.confirmTime==null">
            用户暂未收货
          </div>
          <div v-else>
...
<script>
import { listOrder, shipOrder, refundOrder, detailOrder, alreadyPayOrder } from '@/api/order'
...
export default {
  ...
  methods: {
    ...
    alreadyPay(row){
      alreadyPayOrder(row.id).then(response => {
