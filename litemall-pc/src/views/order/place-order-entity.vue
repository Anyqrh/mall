...
<div class="order container">
    ...
    <van-cell-group>
      ...
      <!--</van-cell>-->
      <van-field v-model="message" placeholder="请输入联系方式和收货地址" label="收货信息备注">
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      cartCheckout({cartId: CartId, couponId: CouponId, grouponRulesId: 0}).then(res => {
          ...
          setLocalStorage({CartId: data.cartId, CouponId: data.couponId});
      });
