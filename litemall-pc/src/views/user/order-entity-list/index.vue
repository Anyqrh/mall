<template>
  <div class="order_list over-hide container">
        ...
        > -->
          ...
          >
            <div>
              ...
              >合计: {{el.actualPrice * 100 | yuan}}</div>
            </div>
              ...
              <!--<van-button size="small" v-if="el.handleOption.delete" @click="delOrder(el.id)">已完成</van-button>-->
...
<script>
import { OrderList, orderList,orderConfirm } from '@/api/api';
