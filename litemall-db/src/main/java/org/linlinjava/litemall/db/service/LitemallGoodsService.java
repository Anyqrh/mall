...
//        PageHelper.startPage(offset, limit);
        ...
        while (litemallGoods.size() > 6) {
            litemallGoods.remove(random.nextInt(litemallGoods.size()));
        }
     ...
     * @return
     */
    public List<LitemallGoods> queryByNew() {
        Random random = new Random();
        LitemallGoodsExample example = new LitemallGoodsExample();
...
//        System.out.println(litemallGoods.size());
